...
export declare class Primitive implements IType {
    static define(size?: number, onPack?: any, onUnpack?: any, name?: string): Primitive;
    size: number;
    name: string;
...
export declare type encoding = "utf8" | "utf16le" | "latin1" | "base64" | "hex" | "ascii" | "binary" | "ucs2";
export declare class String implements IType {
    static define(encoding: encoding, type: IType, onPack?: any, onUnpack?: any, name?: string): String;
    size: number;
    encoding: encoding;
    name: string;
    onPack: (value: any, offset: any) => void;
...
export declare class ByteArr extends Byte {
    ...
    getArr(data: number): unknown[];
    pack(p: Pointer, data: Array<any> | number): void;
}
